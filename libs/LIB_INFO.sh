...
LIBJASPER_DL_ADDR=http://www.ece.uvic.ca/~frodo/jasper/software/jasper-$LIBJASPER_VERSION.zip
...
LIBTIFF_DL_ADDR=http://download.osgeo.org/libtiff/tiff-$LIBTIFF_VERSION.tar.gz
